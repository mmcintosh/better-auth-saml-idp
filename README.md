...
- [x] Auth0: live (Enterprise SAML connection), signed requests over both Redirect and **POST (XML signature)** verified with a certificate learned from Auth0's metadata URL, first/last name attributes ([guide](docs/sp-auth0.md))
