...
- [x] Auth0: live (Enterprise SAML connection), signed requests verified with a certificate learned from Auth0's metadata URL, first/last name attributes ([guide](docs/sp-auth0.md))
