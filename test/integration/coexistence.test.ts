// @better-auth/sso sets samlify's process-global validator at import. The IdP plugin must not
// replace it (DECISIONS.md D-006): the SSO plugin's behaviour stays exactly as its authors chose.
...
describe("coexistence with @better-auth/sso", () => {
  it.skipIf(isWorkerd)("leaves an already-installed samlify validator in place", () => {
