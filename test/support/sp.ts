...
export async function strictSp(
  ...
  /** Encrypted assertions (D-020): the SP's decryption key; both signatures wanted by default. */
  opts: { encPrivateKey?: string; encryptCert?: string; wantMessageSigned?: boolean; wantAssertionsSigned?: boolean } = {},
) {
  ...
  const sp = samlify.ServiceProvider({
    ...
    wantAssertionsSigned: opts.wantAssertionsSigned ?? true,
